...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form role="form" action="${pageContext.request.contextPath}/administrador/areas/nueva" method="post">
                <div class="form-group">
                    <label for="txtNombreArea">Nombre del área:</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="area" id="txtNombreArea" placeholder="Ingresa el nombre del área" required>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered table-hover" id="tabla">
                ...
                <tbody>
                    <c:forEach items="${listarAreas}" var="areas">
                        <tr>
                            <td class="text-center">${areas.idArea}</td>
                            <td>${areas.area}</td>
                            <td class="text-center">
                                <a title="Modificar" class="btn btn-primary btn-sm" href="javascript:detallesAreas('${areas.idArea}')">
                                    <span class="glyphicon glyphicon-search"></span> Modificar
                                </a>
                                <a title="Eliminar" class="btn btn-danger btn-sm" onclick="eliminar('${areas.idArea}')">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form role="form" action="${pageContext.request.contextPath}/administrador/areas/actualizar" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="area" id="nombreArea" required>
                            </div>
                        </div>
...
<script>
    ...
    function detallesAreas(id){
        $.ajax({
            url: "${pageContext.request.contextPath}/administrador/areas/detalles/" + id,
            type: "GET",
            dataType: "JSON",
            success: function (data){
                $('#idArea').val(data.idArea);
                $('#nombreArea').val(data.area);
                $('#modal').modal('show');
            }
        });
    }
